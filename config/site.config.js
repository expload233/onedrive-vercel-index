...
module.exports = {
  ...
  userPrincipalName: process.env.NEXT_PUBLIC_USER_PRINCIPLE_NAME || 'expload@expload.onmicrosoft.com',
  ...
  email: 'mailto:datamasterlive@outlook.com',
